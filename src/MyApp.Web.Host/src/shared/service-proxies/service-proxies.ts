...
export class CreateCMSDto implements ICreateCMSDto {
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["name"] = this.pageName;
        data["displayName"] = this.data;
 ...
 * @return Success
 */
    getAll(keyword: string | null | undefined, isActive: boolean | null | undefined, skipCount: number | null | undefined, maxResultCount: number | null | undefined): Observable<PagedResultDtoOfNAVDto> {
        let url_ = this.baseUrl + "/api/services/app/Nav/GetAll?";
        if (keyword !== undefined)
            url_ += "Keyword=" + encodeURIComponent("" + keyword) + "&";
        if (isActive !== undefined)
            url_ += "IsActive=" + encodeURIComponent("" + isActive) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_: any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfNAVDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfNAVDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<PagedResultDtoOfNAVDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
                ...
                result200 = PagedResultDtoOfNAVDto.fromJS(resultData200);
                // console.log(result200);
                return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
        ...
        return _observableOf<PagedResultDtoOfNAVDto>(<any>null);
    }

}

export class CreateNAVDto implements ICreateNAVDto {
    pageName: string;
    data: string;


    constructor(data?: ICreateNAVDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateNAVDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateNAVDto();
        result.init(data);
        return result;
    }
...
export interface ICreateNAVDto {
    pageName: string;
    data: string;

}

export class NAVDto implements INAVDto {
    pageName: string;
    data: string;
    id: number | undefined;

    constructor(data?: INAVDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): NAVDto {
        data = typeof data === 'object' ? data : {};
        let result = new NAVDto();
        result.init(data);
        return result;
    }
...
export interface INAVDto {
    pageName: string;
    data: string;
    id: number | undefined;
}

export class PagedResultDtoOfNAVDto implements IPagedResultDtoOfNAVDto {
    totalCount: number | undefined;
    items: NAVDto[] | undefined;

    constructor(data?: IPagedResultDtoOfNAVDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): PagedResultDtoOfNAVDto {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDtoOfNAVDto();
        result.init(data);
        return result;
    }
...
export interface IPagedResultDtoOfNAVDto {
    totalCount: number | undefined;
    items: NAVDto[] | undefined;
}
